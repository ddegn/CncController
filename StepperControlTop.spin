DAT programName         byte "StepperControlTop", 0
CON
{
  ******* Private Notes *******
...
PUB TempLoop | localIndex
  ...
  timer := 9999
  Cnc.SetOled(Header#AXES_READOUT_OLED, @xyzLabels, @oledPtr, 4)
  Pst.Clear
  Pst.RxFlush
  ...
  repeat
    ...
    repeat localIndex from 0 to 3
      Pst.Str(Header.FindString(@xyzLabels, localIndex))
  ...
  while result
  L
  Pst.Str(string(11, 13, "End of TempLoop Method"))
  C
...
PUB MainLoop
  ...
  repeat
    ...
    case machineState
      Header#INIT_STATE:  
        \MainMenu 'InitState
      Header#DESIGN_INPUT_MAIN..Header#MANUAL_POTS_MAIN:
        MenuSelection(machineState)
      other:
        Pst.str(string(11, 13, "Unexpected machineState ="))               
        Pst.Dec(machineState)
...
PUB MainMenu
  ...
  repeat
    Pst.Home
    'Pst.str(string(11, 13, "Homed State"))
    Pst.str(string(11, 13, "Machine waiting for input."))  
    'Pst.str(string(11, 13, "Press ", QUOTE, "p", QUOTE, " to enter new Program manually."))
    Pst.str(string(11, 13, "Press ", QUOTE, "o", QUOTE, " to Open design file to create or edit design."))
    Pst.str(string(11, 13, "Press ", QUOTE, "d", QUOTE, " to Display design."))
    Pst.str(string(11, 13, "Press ", QUOTE, "e", QUOTE, " to Execute design."))
    Pst.str(string(11, 13, "Press ", QUOTE, "j", QUOTE, " to manually control machine with Joystick."))  
    Pst.str(string(11, 13, "Press ", QUOTE, "n", QUOTE, " to manually control machine with wii Nunchuck."))
    Pst.str(string(11, 13, "Press ", QUOTE, "p", QUOTE, " to manually control machine with Poteniometers."))
    Pst.str(string(11, 13, "Press ", QUOTE, "h", QUOTE, " to Home machine"))
    if homedFlag
...
PUB CheckMenu(tempValue) 
  ...
  ifnot result
    case tempValue
      ...
      2, "d", "D":
        machineState := Header#DESIGN_REVIEW_STATE
      3, "e", "E":
        machineState := Header#DESIGN_READ_STATE
      4, "j", "J":
        machineState := Header#MANUAL_JOYSTICK_STATE
      5, "n", "N":
        machineState := Header#MANUAL_NUNCHUCK_STATE
      6, "p", "P":
        machineState := Header#MANUAL_POTS_STATE
      7, "h", "H":
...
buttonLabel             byte "Button off", 0
                        ...
                        byte "Pot 3 = ", 0
                        byte "Timer = ", 0
oledMenuLimit           byte 8
oledMenuHighlightRange  byte 1, 7                             
